...
### 풀이 요약
- 연속적인 영역의 총 개수와 영역의 크기를 오름차순으로 출력하는 문제
- 방문 시 0 으로 표시하여 재방문하지 않도록 한다.
- 각각의 1의 개수를 count하고, main에서 2중 for문을 돌 때는 1이면 각 영역의 첫번째로만 방문하게 되는 것이므로 그 때의 횟수를 카운트 하여 총 영역의 개수를 구하면 된다.
