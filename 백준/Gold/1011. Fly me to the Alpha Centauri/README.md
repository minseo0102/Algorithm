...
### 풀이 요약
- 거리에 따른 이동 횟수의 규칙이 존재.
- 그 규칙을 수식으로 표현하고, 이를 이용해서 이동 횟수를 찾아낸다
- 주의할 점은, 입력으로 받는 거리가 2^31까지로 매우 크기 때문에, int가 아닌 long long으로 받아야 data 손실이 없다는 점!
